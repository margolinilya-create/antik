...
export const metadata: Metadata = {
  ...
  description:
    "Публичная оферта RELIQUA: условия подбора, бронирования и продажи антикварных предметов, доставка и возврат.",
